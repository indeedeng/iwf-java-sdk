...
public class WorkflowStateOptionsExtension extends WorkflowStateOptions {
     ...
     * @return this
     */
    public WorkflowStateOptionsExtension setProceedAfterRetryExhaustedOnExecuteFailure(
     ...
     * @return this
     */
    public WorkflowStateOptionsExtension setProceedAfterRetryExhaustedOnWaitUntilFailure(boolean proceed){
